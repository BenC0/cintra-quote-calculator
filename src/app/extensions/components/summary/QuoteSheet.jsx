...
import { QuoteDetailsFormComponent } from "../sales_form/QuoteDetailsForm";
import { PayrollContainer } from "../sales_form/quote/PayrollComponents";

const QuoteSheetComponent = ({ actions, allData = {} }) => {
